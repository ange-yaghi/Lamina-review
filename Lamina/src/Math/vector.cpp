...
lm::vec4d lm::TranslateVector(vec4d &vector, float x, float y, float z)
{
...
lm::vec4d lm::ScaleVector(vec4d &vector, float x, float y, float z)
{
...
lm::vec4d lm::RotateVector(vec4d &vector, float angle, int plane)
{
